    ...
    <Layout>
      <section id="hero">
        <div class="left-column">
          ...
          <Button className='cta' endIcon={<AddShoppingCartIcon />}>
            Shop Now
          </Button>
      ...
      <section id="product" className='section-p1'>
        ...
        <div className="pro-container">
          ...
          />
          <ProductsCard
            picturePath="/images/lol.jpg"
            productName="League of Leagends"
            productPrice="$20.00"
          />
          <ProductsCard
            picturePath="/images/call_of_duty.png"
            productName="Call of Duty Black Ops III"
            productPrice="$60.00"
          />
          <ProductsCard
            picturePath="/images/call_of_duty.png"
